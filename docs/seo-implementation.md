...
Core: [`utils/public-content-seo.ts`](../app-pwa/utils/public-content-seo.ts) (`buildPublicDetailSeoPayload`, rich meta descriptions, AEO fact lists). Wired via [`composables/usePublicDetailSeo.ts`](../app-pwa/composables/usePublicDetailSeo.ts) and thin wrappers in [`composables/usePublicContentSeo.ts`](../app-pwa/composables/usePublicContentSeo.ts). Visible AEO summary: `PublicContentAeoSummary` on each detail template.
...
- `app-pwa/components/seo/AppBreadcrumbs.vue`
