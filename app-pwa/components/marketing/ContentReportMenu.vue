...
const summaryClass = computed(() =>
  props.onHero
    ? 'inline-flex h-10 w-10 cursor-pointer list-none items-center justify-center rounded-full border border-white/20 bg-white/90 text-[13px] font-semibold text-black/55 shadow-sm backdrop-blur-sm hover:bg-white hover:text-black/75 [&::-webkit-details-marker]:hidden'
    : 'inline-flex h-10 w-10 cursor-pointer list-none items-center justify-center rounded-full border border-black/10 bg-white text-[13px] font-semibold text-black/55 hover:bg-neutral-50 hover:text-black/75 [&::-webkit-details-marker]:hidden',
)
