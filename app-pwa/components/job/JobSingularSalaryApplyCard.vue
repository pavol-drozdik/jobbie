<template>
  <div class="relative flex flex-col gap-3.5 overflow-visible rounded-[20px] bg-white p-7 shadow-[0_0_12px_rgba(0,0,0,0.07)]">
    ...
    <button
      ...
      type="button"
      disabled
      class="flex h-14 w-full cursor-not-allowed items-center justify-center rounded-full border border-gray-200 bg-gray-50 text-lg font-semibold text-black/45"
