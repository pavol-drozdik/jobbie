...
export function useSettingsFormStyles() {
  ...
  const outlineFileButtonClass =
    'inline-flex min-h-[44px] cursor-pointer items-center justify-center rounded-full border-[1.5px] border-[#e5e7eb] bg-marketing-surface px-4 py-2 font-dmSans text-[15px] font-semibold text-black/80 transition-colors hover:border-marketing-green hover:text-marketing-green disabled:cursor-not-allowed disabled:opacity-50'

  const textLinkButtonClass =
    'inline-flex min-h-[44px] cursor-pointer items-center justify-center rounded-full border-[1.5px] border-transparent bg-transparent px-3 py-2 font-dmSans text-[15px] font-semibold text-black/55 underline decoration-black/25 underline-offset-2 hover:text-red-700 hover:decoration-red-700/60'
